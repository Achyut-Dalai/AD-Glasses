...
### Summary
Implemented Chapter 3 requirements for Bluetooth scanning + pairing UI in `android/AD-Glasses`:
...
### Key files
- `app/src/main/java/com/ad_glasses/devices/`
...
- `app/src/main/java/com/ad_glasses/ui/DeviceListAdapter.kt`
...
- Tests: `app/src/test/java/com/ad_glasses/devices/DeviceClassifierTest.kt`
