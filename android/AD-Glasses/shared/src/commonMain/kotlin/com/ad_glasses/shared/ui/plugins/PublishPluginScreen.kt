package com.ad_glasses.shared.ui.plugins
...
import com.ad_glasses.shared.plugins.PublishPluginUiState
import com.ad_glasses.shared.ui.localizedPluginCategory
...
fun PublishPluginScreen(
    ...
    onExternalSourceLinkChanged: (String) -> Unit,
    onSubmit: () -> Unit,
    onNavigateBack: () -> Unit,
) {
    Scaffold(
        ...
        Column(
            ...
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(
                    ...
                    PluginTextField(
                        value = state.externalSourceLink,
                        onValueChange = onExternalSourceLinkChanged,
                        label = stringResource(Res.string.publish_external_source_link),
                        error = state.externalSourceLinkError,
                        tag = "publish_plugin_link",
                        keyboardType = KeyboardType.Uri,
                    )
                    Text(
                        text = stringResource(Res.string.publish_external_source_hint),
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant,
                    )
                }
