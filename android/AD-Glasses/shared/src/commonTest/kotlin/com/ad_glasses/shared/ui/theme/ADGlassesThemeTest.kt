package com.ad_glasses.shared.ui.theme
...
class ADGlassesThemeTest {
    ...
    fun schemeUsesProfileSecondaryAndTertiaryColorsInBothModes() {
        ...
        val light = ADGlassesColorScheme(profile, darkTheme = false, highContrast = false)
        val dark = ADGlassesColorScheme(profile, darkTheme = true, highContrast = false)
    ...
    fun highContrastAndThemeModeMappingArePlatformIndependent() {
        ...
        val highContrastLight = ADGlassesColorScheme(profile, darkTheme = false, highContrast = true)
        val highContrastDark = ADGlassesColorScheme(profile, darkTheme = true, highContrast = true)
