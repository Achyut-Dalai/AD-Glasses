...
The KMP host at `ios/AD-GlassesKMPHost/AD-GlassesKMPHostApp.swift` only embeds the shared Compose controller. There is no `MWDATCore`, `MWDATCamera`, or `MWDATDisplay` package in the current iOS target.
...
- `shared/src/iosMain/kotlin/com/ad_glasses/shared/platform/MainViewController.kt:196-399`
- `shared/src/iosMain/kotlin/com/ad_glasses/shared/ble/IosBleManager.kt:42-49`
...
- `app/src/main/java/com/ad_glasses/devices/metarayban/MetaRaybanManager.kt`
- `app/src/main/java/com/ad_glasses/MainActivity.kt:430-650`
- `app/src/main/java/com/ad_glasses/MainActivity.kt:3633-3797`
- `app/build.gradle:190-200`
- `app/src/main/AndroidManifest.xml:77-86`
- `app/src/main/java/com/ad_glasses/devices/DeviceClassifier.kt`
- `app/src/main/java/com/ad_glasses/ui/DeviceBindActivity.kt`

### Shared UI and gating

- `shared/src/commonMain/kotlin/com/ad_glasses/shared/devices/GlassesManagerGating.kt`
- `shared/src/commonMain/kotlin/com/ad_glasses/shared/glasses/GlassesDashboardPresentation.kt`
- `shared/src/commonMain/kotlin/com/ad_glasses/shared/ui/glasses/GlassesDashboardScreen.kt`
- `shared/src/commonMain/kotlin/com/ad_glasses/shared/ui/SharedDestinationScreen.kt`
- `shared/src/androidMain/kotlin/com/ad_glasses/shared/ble/AndroidBleManager.kt`
- `shared/src/commonMain/kotlin/com/ad_glasses/shared/glasses/GlassesSessionCoordinator.kt`

### iOS KMP and HeyCyan transport

- `ios/AD-GlassesKMPHost/AD-GlassesKMPHostApp.swift`
- `ios/AD Glasses_KMP_IOS.md`
- `shared/src/iosMain/kotlin/com/ad_glasses/shared/platform/MainViewController.kt`
- `shared/src/iosMain/kotlin/com/ad_glasses/shared/ble/IosBleManager.kt`
- `shared/src/iosMain/kotlin/com/ad_glasses/shared/media/IosMediaTransfer.kt`

### Plugin paths requiring migration or gating

- `app/src/main/java/com/ad_glasses/plugins/PluginVoiceSupport.kt`
- `app/src/main/java/com/ad_glasses/plugins/walkingaid/WalkingAidService.kt`
- `app/src/main/java/com/ad_glasses/plugins/meetingsparknotes/MeetingSparkNotesService.kt`
- `app/src/main/java/com/ad_glasses/plugins/livecaptionrelay/LiveCaptionRelayService.kt`
