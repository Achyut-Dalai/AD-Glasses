package com.ad_glasses.ui.glasses
                ...
                GlassesDashboardScreen(
                    state = GlassesDashboardUiState(
                        firmwarePatchRequest = FirmwarePatchRequestUiState(
                            ...
                            target = com.ad_glasses.shared.glasses.OtaTargetSelection.V821_WIFI,
                ...
                GlassesDashboardScreen(
                    state = GlassesDashboardUiState(
                        firmwarePatchRequest = FirmwarePatchRequestUiState(
                            ...
                            target = com.ad_glasses.shared.glasses.OtaTargetSelection.JIELI_BLE,
