(function() {
    ...
    class EvenAppBridgeShim {
        ...
        async createStartUpPageContainer(params) {
            ...
            if (text && window.AD GlassesEvenHubBridge) {
                window.AD GlassesEvenHubBridge.createPage(JSON.stringify(params));
            }
            return 0; // success
        }
        ...
        async textContainerUpgrade(containerID, containerName, content, contentOffset, contentLength) {
            ...
            if (window.AD GlassesEvenHubBridge) {
                window.AD GlassesEvenHubBridge.updateText(containerID, containerName, content, contentOffset, contentLength);
            }
            return true;
        }
        ...
        async rebuildPageContainer(params) {
            ...
            if (window.AD GlassesEvenHubBridge) {
                window.AD GlassesEvenHubBridge.rebuildPage(JSON.stringify(params));
            }
            return true;
        }
        ...
        async shutDownPageContainer(exitMode) {
            ...
            if (window.AD GlassesEvenHubBridge) {
                window.AD GlassesEvenHubBridge.shutDown(exitMode);
            }
            return true;
        }
