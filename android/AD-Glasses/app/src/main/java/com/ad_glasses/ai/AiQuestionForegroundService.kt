...
import com.ad_glasses.glasses.runtime.ADPersistentGlassesRuntime
import com.ad_glasses.ui.WelcomeActivity
...
class AiQuestionForegroundService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_START = "com.ad_glasses.action.AI_QUESTION_START"
        private const val ACTION_STOP = "com.ad_glasses.action.AI_QUESTION_STOP"
        private const val ACTION_RUNTIME_START = "com.ad_glasses.action.AD_RUNTIME_START"
        private const val ACTION_RUNTIME_STOP = "com.ad_glasses.action.AD_RUNTIME_STOP"
