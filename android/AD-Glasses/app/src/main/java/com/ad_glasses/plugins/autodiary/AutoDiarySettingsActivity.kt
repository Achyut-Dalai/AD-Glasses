package com.ad_glasses.plugins.autodiary
...
import com.ad_glasses.ui.localagent.AppBlacklistActivity
import com.ad_glasses.ui.localagent.DailyFactsActivity
import com.ad_glasses.ui.localagent.ScreenCapturesActivity
import com.ad_glasses.ui.localagent.DailySummaryActivity
...
fun AutoDiarySettingsScreen(
    ...
    var autoSaveFacts by remember { mutableStateOf(com.ad_glasses.localagent.userfacts.ChatMemoryPrefs.isAutoSaveDailyFactsEnabled(context)) }
    var extractFacts by remember { mutableStateOf(com.ad_glasses.localagent.userfacts.ChatMemoryPrefs.isExtractUserFactCandidatesEnabled(context)) }
    ...
    Scaffold(
        ...
        Column(
            ...
            NativePluginShortcutPreference(
                pluginId = com.ad_glasses.shared.plugins.NativePluginIds.AUTO_DIARY,
            ...
            SwitchSetting(stringResource(R.string.compose_auto_save_daily_facts), autoSaveFacts) {
                autoSaveFacts = it
                com.ad_glasses.localagent.userfacts.ChatMemoryPrefs.setAutoSaveDailyFactsEnabled(context, it)
            }
            SwitchSetting(stringResource(R.string.compose_extract_user_fact_candidates), extractFacts) {
                extractFacts = it
                com.ad_glasses.localagent.userfacts.ChatMemoryPrefs.setExtractUserFactCandidatesEnabled(context, it)
            }
            NumberSetting(
