...
import com.ad_glasses.shared.settings.CaptureSource
import com.ad_glasses.audio.MeetingCapturePrefs
import com.ad_glasses.audio.MeetingCaptureService
import com.ad_glasses.media.GlassesMediaPrefs
import com.ad_glasses.media.SyncedMediaFolder
import com.ad_glasses.media.VendorAlbumDownloader
import com.ad_glasses.ota.FirmwareClient
import com.ad_glasses.ota.InstalledFirmwareVersions
import com.ad_glasses.ota.FirmwareResult
import com.ad_glasses.ota.OtaManager
import com.ad_glasses.ota.OtaReadinessStage
import com.ad_glasses.ota.OtaState
import com.ad_glasses.ota.OtaTarget
import com.ad_glasses.ota.expectedFirmwareExtension
import com.ad_glasses.ota.firmwareRelayBaseUrl
import com.ad_glasses.ota.isExpectedFirmwareFilename
import com.ad_glasses.glasses.GlassesSession
import com.ad_glasses.glasses.GlassesSessionLease
import com.ad_glasses.glasses.GlassesSessionCoordinator
import com.ad_glasses.glasses.BackgroundGlassesCommandPermit
import com.ad_glasses.glasses.GlassesTransportSecurityPolicy
import com.ad_glasses.wifiadb.DefaultWifiAdbDebugControllerFactory
...
import com.ad_glasses.media.autocapture.GlassesSyncedAudioIngestor
...
import com.ad_glasses.databinding.AcitivytMainBinding
import com.ad_glasses.ui.DeviceBindActivity
...
import com.ad_glasses.plugins.livecaptionrelay.LiveCaptionRelayService
...
import com.ad_glasses.ui.adglasses.ADAutomation
import com.ad_glasses.ui.adglasses.ADGlassesApp
import com.ad_glasses.ui.adglasses.ADHostActions
import com.ad_glasses.ui.BluetoothUtils
import com.ad_glasses.ui.BluetoothEvent
import com.ad_glasses.ui.AutoPairManager
import com.ad_glasses.chat.ChatStore
import com.ad_glasses.devices.DeviceProfileStore
import com.ad_glasses.devices.eyevue.EyevueManager
import com.ad_glasses.devices.eyevue.EyevueLivePreviewManager
import com.ad_glasses.devices.eyevue.EyevueMediaProfile
import com.ad_glasses.devices.eyevue.EyevueMediaSync
import com.ad_glasses.devices.eyevue.EyevueMediaType
import com.ad_glasses.devices.eyevue.EyevueWifiTransport
import com.ad_glasses.devices.meizumyvu.MeizuMyvuManager
...
import com.ad_glasses.ai.transcription.OpenAIWhisperTranscriptionProvider
import com.ad_glasses.ai.transcription.RetryPolicy
import com.ad_glasses.ai.transcription.RetryingTranscriptionProvider
import com.ad_glasses.ai.transcription.TranscriptionProgress
...
import com.ad_glasses.ui.bleIpBridge
import com.ad_glasses.ui.hasBluetooth
import com.ad_glasses.ui.hasAccessibilityServicePermission
import com.ad_glasses.ui.hasNotificationPermission
import com.ad_glasses.ui.hasWifiP2pPermission
import com.ad_glasses.ui.requestBluetoothPermission
import com.ad_glasses.ui.requestAccessibilityServicePermission
import com.ad_glasses.ui.ensureNotificationPermission
import com.ad_glasses.ui.requestWifiP2pPermission
import com.ad_glasses.ui.setOnClickListener
import com.ad_glasses.ui.startKtxActivity
...
import com.ad_glasses.ai.vision.ResolvedImageQuestionPrompt
import com.ad_glasses.ai.image.ImageQuestionSource
import com.ad_glasses.ai.image.ImageQuestionSourcePolicy
import com.ad_glasses.ai.image.ImageThumbnailQuality
import com.ad_glasses.ai.AiQuestionForegroundService
import com.ad_glasses.ai.image.HighQualityFailureChoice
...
import com.ad_glasses.shared.glasses.FirmwarePatchRequestUiState
...
import com.ad_glasses.shared.glasses.MeizuMyvuUiState
import com.ad_glasses.shared.glasses.OtaFirmwareSource
import com.ad_glasses.shared.glasses.WifiAdbDebugUiState
import com.ad_glasses.shared.navigation.AppDestination
import com.ad_glasses.shared.plugins.NativePluginIds
import com.ad_glasses.shared.plugins.NativePluginShortcutAction
import com.ad_glasses.shared.plugins.NativePluginShortcutButton
import com.ad_glasses.shared.plugins.NativePluginShortcutUiState
import com.ad_glasses.localagent.LocalAgentAccessibilityBridge
import com.ad_glasses.localagent.context.LocalAgentContextBuilder
import com.ad_glasses.localagent.dailyfacts.DailyFactsStorage
...
import com.ad_glasses.shared.ui.ADGlassesApp
...
class MainActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private val livePreviewManager by lazy { com.ad_glasses.ota.LivePreviewManager(this) }
    ...
    private var metaRaybanManager: com.ad_glasses.devices.metarayban.MetaRaybanManager? = null
    ...
    private fun getOrCreateMetaRaybanManager(): com.ad_glasses.devices.metarayban.MetaRaybanManager {
        return metaRaybanManager
            ?: com.ad_glasses.devices.metarayban.MetaRaybanManager
                .getInstance(this)
                .also { manager ->
    ...
    private fun observeMetaRaybanState(
        manager: com.ad_glasses.devices.metarayban.MetaRaybanManager,
    ) {
                ...
                eyevueLivePreviewUiJob = lifecycleScope.launch {
                    manager.uiState.collect { lp ->
                        ...
                        dashboardState = dashboardState.copy(
                            livePreview = com.ad_glasses.shared.glasses.LivePreviewUiState(
            ...
            AppDestination.CHATS -> {
                ...
                val lastUserAt = last?.let { thread ->
                    ChatStore.listMessages(thread.id)
                        .lastOrNull { it.role == com.ad_glasses.shared.chat.ChatRole.USER }
                        ?.createdAt
                } ?: 0L
    ...
    private fun observeOtaState() {
        lifecycleScope.launch {
            otaManager.uiState.collect { ota ->
                ...
                dashboardState = dashboardState.copy(
                    ota = com.ad_glasses.shared.glasses.OtaSectionUiState(
    ...
    private fun OtaTarget.toOtaTargetSelection(): com.ad_glasses.shared.glasses.OtaTargetSelection = when (this) {
        OtaTarget.V821_WIFI -> com.ad_glasses.shared.glasses.OtaTargetSelection.V821_WIFI
        OtaTarget.JIELI_BLE -> com.ad_glasses.shared.glasses.OtaTargetSelection.JIELI_BLE
    }
    ...
    private fun updateConnectionStatus(connected: Boolean) {
        ...
        if (isMetaRaybanSelected()) {
            ...
            val status = when {
                ...
                manager.registrationState.value == com.ad_glasses.devices.metarayban.MetaRaybanManager.RegistrationState.REGISTERED ->
    ...
    private fun configureHeyCyanWakeWordIfNeeded() {
        if (wakeWordConfiguredForConnection ||
            ...
            DeviceProfileStore.selectedClass(this) != com.ad_glasses.shared.devices.DeviceClass.HEY_CYAN
        ) {
            return
        }
    ...
    private fun isEyevueSelected(): Boolean =
        DeviceProfileStore.selectedClass(this) == com.ad_glasses.shared.devices.DeviceClass.EYEVUE

    private fun isHeyCyanOrEyevueSelected(): Boolean =
        DeviceProfileStore.selectedClass(this) in setOf(
            com.ad_glasses.shared.devices.DeviceClass.HEY_CYAN,
            com.ad_glasses.shared.devices.DeviceClass.EYEVUE,
        )
    ...
    private fun updateMetaRaybanUiState() {
        ...
        binding.btnMetaRegister.isEnabled = regState != com.ad_glasses.devices.metarayban.MetaRaybanManager.RegistrationState.REGISTERED &&
            regState != com.ad_glasses.devices.metarayban.MetaRaybanManager.RegistrationState.REGISTERING
        binding.btnMetaUnregister.isEnabled = regState == com.ad_glasses.devices.metarayban.MetaRaybanManager.RegistrationState.REGISTERED

        binding.btnMetaSessionStart.isEnabled = regState == com.ad_glasses.devices.metarayban.MetaRaybanManager.RegistrationState.REGISTERED &&
            manager.availableDeviceCount.value > 0 &&
            sessionState == com.ad_glasses.devices.metarayban.MetaRaybanManager.DeviceSessionState.IDLE
        binding.btnMetaSessionStop.isEnabled = sessionState != com.ad_glasses.devices.metarayban.MetaRaybanManager.DeviceSessionState.IDLE

        binding.btnMetaStreamStart.isEnabled = sessionState == com.ad_glasses.devices.metarayban.MetaRaybanManager.DeviceSessionState.STARTED &&
            streamState == com.ad_glasses.devices.metarayban.MetaRaybanManager.StreamState.STOPPED
        binding.btnMetaStreamStop.isEnabled = streamState == com.ad_glasses.devices.metarayban.MetaRaybanManager.StreamState.STREAMING

        binding.btnMetaCapturePhoto.isEnabled = streamState == com.ad_glasses.devices.metarayban.MetaRaybanManager.StreamState.STREAMING

        binding.btnMetaViewPhoto.isEnabled = manager.lastCapturedPhoto.value != null
        binding.btnMetaDisplayStart.isEnabled = displayCapable && sessionState == com.ad_glasses.devices.metarayban.MetaRaybanManager.DeviceSessionState.STARTED && !isDisplayActive
        ...
        updateDashboardState { state ->
            state.copy(
                metaRayban = MetaRaybanUiState(
                    ...
                    canRegister = regState != com.ad_glasses.devices.metarayban.MetaRaybanManager.RegistrationState.REGISTERED &&
                        regState != com.ad_glasses.devices.metarayban.MetaRaybanManager.RegistrationState.REGISTERING,
                    canUnregister = regState == com.ad_glasses.devices.metarayban.MetaRaybanManager.RegistrationState.REGISTERED,
                    canStartSession = regState == com.ad_glasses.devices.metarayban.MetaRaybanManager.RegistrationState.REGISTERED &&
                        manager.availableDeviceCount.value > 0 &&
                        sessionState == com.ad_glasses.devices.metarayban.MetaRaybanManager.DeviceSessionState.IDLE,
                    canStopSession = sessionState != com.ad_glasses.devices.metarayban.MetaRaybanManager.DeviceSessionState.IDLE,
                    canStartStream = sessionState == com.ad_glasses.devices.metarayban.MetaRaybanManager.DeviceSessionState.STARTED &&
                        streamState == com.ad_glasses.devices.metarayban.MetaRaybanManager.StreamState.STOPPED,
                    canStopStream = streamState == com.ad_glasses.devices.metarayban.MetaRaybanManager.StreamState.STREAMING,
                    canCapturePhoto = streamState == com.ad_glasses.devices.metarayban.MetaRaybanManager.StreamState.STREAMING,
    ...
    private fun createDownloadSession() {
        ...
        vendorAlbumDownloader = if (downloadFlowMode == GlassesSyncFlow.OFFICIAL_HEYCYAN) {
            VendorAlbumDownloader(
                ...
                requestTag = "ADGlasses_heycyan_album_$downloadSessionId",
            )
        } else {
            null
        }
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Retry high quality") { _, _ ->
                when (ImageQuestionSourcePolicy.resolveHighQualityFailure(HighQualityFailureChoice.RETRY_HIGH_QUALITY)) {
                    com.ad_glasses.ai.image.ImageSourceResolution.HIGH_QUALITY -> {
            ...
            .setNegativeButton("Use fast preview") { _, _ ->
                if (
                    ...
                    com.ad_glasses.ai.image.ImageSourceResolution.FAST_PREVIEW
                ) {
                    highQualityImageRequest = null
            ...
            .setNeutralButton("Cancel") { _, _ ->
                if (
                    ...
                    com.ad_glasses.ai.image.ImageSourceResolution.CANCELLED
                ) {
                    highQualityImageRequest = null
