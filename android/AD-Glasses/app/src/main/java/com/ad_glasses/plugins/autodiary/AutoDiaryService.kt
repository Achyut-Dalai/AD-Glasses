...
import com.ad_glasses.memoryvault.MemoryModeManager
...
class AutoDiaryService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.ad_glasses.action.AUTO_DIARY_START"
        const val ACTION_STOP = "com.ad_glasses.action.AUTO_DIARY_STOP"
        const val ACTION_SUMMARIZE = "com.ad_glasses.action.AUTO_DIARY_SUMMARIZE"
