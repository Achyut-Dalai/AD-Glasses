...
object DebugLogSupport {
    ...
    fun showSupportOptionsDialog(
        ...
        val message = buildString {
            ...
            append("\n\nYou can either send the detailed logs straight to the ADGlasses server or export an email-ready log file.\n\n")
    ...
    private fun buildEmailIntent(
        ...
        return Intent(Intent.ACTION_SEND).apply {
            ...
            putExtra(Intent.EXTRA_SUBJECT, "ADGlasses logs: $issueType")
            putExtra(
                Intent.EXTRA_TEXT,
                buildString {
                    appendLine("Please find the attached ADGlasses debug logs.")
                    appendLine()
    ...
    private fun writeManualLogFile(
        ...
        file.writeText(
            buildString {
                appendLine("=== ADGlasses Debug Report ===")
                appendLine("Issue Type: $issueType")
