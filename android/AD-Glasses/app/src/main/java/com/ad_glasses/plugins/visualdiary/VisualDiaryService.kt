...
import com.ad_glasses.devices.DeviceCapabilityHelper
...
class VisualDiaryService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.ad_glasses.action.VISUAL_DIARY_START"
        const val ACTION_STOP = "com.ad_glasses.action.VISUAL_DIARY_STOP"
        const val ACTION_CAPTURE_NOW = "com.ad_glasses.action.VISUAL_DIARY_CAPTURE_NOW"
