...
import com.ad_glasses.localagent.LocalAgentLanguage
...
class LocalAgentService : Service() {
    ...
    private fun buildNotification(content: String): Notification {
        val target = if (content == "Waiting for your approval") {
            com.ad_glasses.ui.localagent.PendingActionsActivity::class.java
        } else {
    ...
    companion object {
        ...
        private const val ACTION_START_LEGACY = "com.ad_glasses.action.LOCAL_AGENT_START"
        private const val ACTION_STOP_LEGACY = "com.ad_glasses.action.LOCAL_AGENT_STOP"
