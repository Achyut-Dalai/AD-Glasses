...
class MeetingCaptureService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.ad_glasses.action.MEETING_CAPTURE_START"
        const val ACTION_STOP = "com.ad_glasses.action.MEETING_CAPTURE_STOP"

        const val ACTION_STATE = "com.ad_glasses.action.MEETING_CAPTURE_STATE"
