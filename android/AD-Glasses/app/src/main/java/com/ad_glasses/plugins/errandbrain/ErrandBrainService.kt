...
class ErrandBrainService : Service() {
    ...
    companion object {
        const val ACTION_START = "com.ad_glasses.ACTION_START_ERRAND"
        const val ACTION_STOP = "com.ad_glasses.ACTION_STOP_ERRAND"
        const val ACTION_ADD_TASK = "com.ad_glasses.ACTION_ADD_TASK"
        const val ACTION_ADD_REMINDER = "com.ad_glasses.ACTION_ADD_REMINDER"
