package com.ad_glasses.data.local

import androidx.room.Database
import androidx.room.RoomDatabase
import androidx.room.migration.Migration
import androidx.sqlite.db.SupportSQLiteDatabase
import com.ad_glasses.data.local.dao.CaptureSessionDao
import com.ad_glasses.data.local.dao.CaptureTranscriptDao
import com.ad_glasses.data.local.dao.ChatDao
import com.ad_glasses.data.local.dao.MemoryChunkDao
import com.ad_glasses.data.local.dao.MemoryVaultDao
import com.ad_glasses.data.local.dao.MessageDao
import com.ad_glasses.data.local.dao.NoteDao
import com.ad_glasses.data.local.dao.PendingActionDao
import com.ad_glasses.data.local.dao.TranscriptionDao
import com.ad_glasses.data.local.entity.CaptureSession
import com.ad_glasses.data.local.entity.CaptureTranscript
import com.ad_glasses.data.local.entity.Chat
import com.ad_glasses.data.local.entity.LocalEmbeddingStoreEntity
import com.ad_glasses.data.local.entity.LocalSearchIndexStateEntity
import com.ad_glasses.data.local.entity.MemoryChunk // (FTS5 table created via SQL; no Room entity)
import com.ad_glasses.data.local.entity.MemoryModePreferenceEntity
import com.ad_glasses.data.local.entity.MemoryPolicyMetadataEntity
import com.ad_glasses.data.local.entity.Message
import com.ad_glasses.data.local.entity.MigrationStateEntity
import com.ad_glasses.data.local.entity.Note
import com.ad_glasses.data.local.entity.PendingAction
import com.ad_glasses.data.local.entity.SyncPayloadManifestEntity
import com.ad_glasses.data.local.entity.SyncPreparationQueueEntity
import com.ad_glasses.data.local.entity.TranscriptionRecord
import com.ad_glasses.data.local.entity.VaultItemEntity
import com.ad_glasses.data.local.entity.VaultItemKeyEntity
import com.ad_glasses.data.local.entity.VaultLockStateEntity
