...
class ModelDownloadForegroundService : Service() {
    ...
    companion object {
        ...
        const val ACTION_DOWNLOAD = "com.ad_glasses.action.DOWNLOAD_MODEL"
        const val ACTION_CANCEL = "com.ad_glasses.action.CANCEL_DOWNLOAD"
        const val EXTRA_MODEL_ID = "model_id"
        const val EXTRA_HF_TOKEN = "hf_token"

        const val BROADCAST_DOWNLOAD_FINISHED = "com.ad_glasses.DOWNLOAD_FINISHED"
        const val BROADCAST_PROGRESS = "com.ad_glasses.DOWNLOAD_PROGRESS"
