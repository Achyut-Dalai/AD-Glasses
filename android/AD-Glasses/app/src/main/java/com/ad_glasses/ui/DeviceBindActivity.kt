...
import com.ad_glasses.shared.devices.ScannedDevice as SharedScannedDevice
...
import com.ad_glasses.devices.DeviceClassifier
import com.ad_glasses.devices.DeviceProfileStore
import com.ad_glasses.devices.ScannedDevice
import com.ad_glasses.ui.adglasses.ADGlassesPairingScreen
...
class DeviceBindActivity : BaseActivity() {
    ...
    private fun upsertDevice(
        ...
        if (sanitizedName == null && detectedClass == com.ad_glasses.shared.devices.DeviceClass.UNKNOWN) return
