...
-keep class com.ad_glasses.localagent.shizuku.LocalAgentShizukuUserService { <init>(...); *; }
...
-keepclassmembers class com.ad_glasses.MainActivity {
    private void handleDashboardAction(com.ad_glasses.shared.glasses.GlassesDashboardAction);
    private com.ad_glasses.shared.glasses.GlassesDashboardUiState getDashboardState();
}
