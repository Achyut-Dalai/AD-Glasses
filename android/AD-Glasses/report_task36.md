...
- `app/src/main/java/com/ad_glasses/audio/MeetingCaptureService.kt` (new)
- `app/src/main/java/com/ad_glasses/audio/CaptureSource.kt` (new)
- `app/src/main/java/com/ad_glasses/audio/MeetingCapturePrefs.kt` (new)
- `app/src/main/java/com/ad_glasses/audio/CaptureTimer.kt` (new; pure helper for unit tests)
- `app/src/main/java/com/ad_glasses/data/local/entity/CaptureSession.kt` (new)
- `app/src/main/java/com/ad_glasses/data/local/dao/CaptureSessionDao.kt` (new)
- `app/src/main/java/com/ad_glasses/data/local/AppDatabase.kt` (version bump to 2 + migration 1→2)
- `app/src/main/java/com/ad_glasses/ui/MyApplication.kt` (adds migration)
- `app/src/main/java/com/ad_glasses/data/repository/AD-GlassesRepository.kt` (session insert/query)
- `app/src/main/res/layout/acitivyt_main.xml` (meeting controls + banner)
- `app/src/main/AndroidManifest.xml` (permissions + service)
- `app/src/test/java/com/ad_glasses/audio/CaptureTimerTest.kt` (new)
