...
FALLBACK_SOURCE_DIR="$ROOT_DIR/../../../../AD-Glasses/_local_termux_server_phone_current"
SOURCE_DIR="${AD Glasses_SERVER_SOURCE:-}"
CARELENS_PROJECT_JSON="$ROOT_DIR/../../Carelens/.vercel/project.json"
LOCAL_PROJECT_JSON="$ROOT_DIR/.vercel/project.json"
STAGE_DIR="$(mktemp -d /tmp/opencode/AD Glasses-vercel-XXXXXX)"
...
printf 'Staged minimal AD Glasses Vercel deploy at %s\n' "$STAGE_DIR"
du -sh "$STAGE_DIR"
