AD Glasses Vercel deployment bundle.

This folder stages only the AD Glasses server files that Vercel needs.

Source server code:
- default: `../_local_termux_server/app.py`
- fallback: `../../../../AD-Glasses/_local_termux_server_phone_current/app.py`
- override via `AD Glasses_SERVER_SOURCE=/absolute/path/to/server`
