...
Until native MyClone bundle export lands in-app, MyClone currently supports converting existing `AD Glasses_backup_v1` zip backups into contract bundles using:

```bash
python /home/fertroll10/Documents/ML/BrainResearch/MyClone/scripts/convert_AD Glasses_backup.py \
  --backup-zip /path/to/AD Glasses_backup.zip \
...
`AD Glasses_backup_v1/files/local_agent_memory/supervision_actions/supervision_actions.jsonl`
...
`AD Glasses_backup_v1/derived/myclone/screen_captures_decrypted/YYYY-MM-DD.jsonl`
