...
const styles = StyleSheet.create({
  ...
  viewer: {width: '100%', minHeight: 320, borderRadius: radius.hero, overflow: 'hidden', backgroundColor: color.black},
  heroImage: {width: '100%', height: 420, backgroundColor: color.black},
