...
**Date:** 2026-07-17
**Artifact:** `CyanBridge_wifi_chip_debug.swu`
...
## 1.3 CyanBridge Debug-Only Integration

CyanBridge now contains a source-set-gated ADB-over-P2P workflow:
...
PC commands after CyanBridge reports `Relay ready`:
...
```text
Path: android/CyanBridge/docs/CyanBridge_wifi_chip_debug.swu
...
WORK="$(mktemp -d /tmp/cyanbridge-swu-audit.XXXXXX)"
