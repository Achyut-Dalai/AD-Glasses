...
object LocalModelCatalogRepository {
    val curatedModels: List<LocalModelCatalogEntry> = listOf(
        ...
        LocalModelCatalogEntry(
            ...
            quantization = "Q4_K_M",
            contextSizeDefault = 2048,
            promptTemplateId = "qwen_chat",
            minRamGb = 3.0,
            minStorageGb = 1.0,
            shortDescription = "Low-memory multilingual model for offline replies, commands, and short translations.",
            tags = listOf("fast", "offline", "starter", "multilingual"),
            gatedDownload = false,
            licenseTermsNote = "Use under Qwen model license terms.",
            enabled = true,
        ),
