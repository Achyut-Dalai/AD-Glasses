package com.achyut.adglasses.shared.localmodels.catalog
...
object LocalModelCatalogRepository {
    val curatedModels: List<LocalModelCatalogEntry> = listOf(
        LocalModelCatalogEntry(
            id = "gemma4-2b-npu-coming-soon",
            displayName = "Gemma 4 2B (NPU - Coming Soon)",
            family = "gemma",
            engine = "litert",
            format = "litertlm",
            sourceUrl = null,
            sourcePageUrl = "https://huggingface.co/litert-community",
            expectedFilename = "gemma-4-2b-npu.litertlm",
            sha256 = null,
