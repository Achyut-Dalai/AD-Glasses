...
class MyApplication : Application(){
    ...
    private fun initSharedServices() {
        ...
        val chatRepo = com.achyut.adglasses.ui.AndroidChatRepositoryWrapper()
        val notesRepo = com.achyut.adglasses.ui.AndroidNotesRepositoryWrapper()
        val deviceRepo = com.achyut.adglasses.ui.AndroidDeviceProfileRepositoryWrapper()
        val vaultRepo = com.achyut.adglasses.ui.AndroidMemoryVaultRepositoryWrapper()
        val mediaRepo = com.achyut.adglasses.ui.AndroidMediaRecordRepositoryWrapper()

        // Create AI services
        val chatAi = com.achyut.adglasses.ui.AndroidChatAiService()
        val voiceAi = com.achyut.adglasses.ui.AndroidVoiceAiService()
        val imageAi = com.achyut.adglasses.ui.AndroidImageAiService()
        val modelRegistry = com.achyut.adglasses.ui.AndroidAiModelRegistry()
    ...
    companion object {
        ...
        val repository: com.achyut.adglasses.data.repository.ADGlassesRepository by lazy {
            com.achyut.adglasses.data.repository.ADGlassesRepository(database)
        }
