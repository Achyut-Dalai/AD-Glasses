...
object DebugLogSupport {
    ...
    fun showSupportOptionsDialog(
        ...
        val message = buildString {
            ...
            append("\n\nYou can either send the detailed logs straight to the AD Glasses server or export an email-ready log file.\n\n")
    ...
    suspend fun sendLogsToServer(
        ...
        val token = ServerPrefs.getApiToken(context)
    ...
    private fun buildEmailIntent(
        ...
        return Intent(Intent.ACTION_SEND).apply {
            ...
            putExtra(Intent.EXTRA_SUBJECT, "AD Glasses logs: $issueType")
            putExtra(
                Intent.EXTRA_TEXT,
                buildString {
                    appendLine("Please find the attached AD Glasses debug logs.")
                    appendLine()
    ...
    private fun writeManualLogFile(
        ...
        val safeType = issueType
            ...
            .trim('-')
            .ifBlank { "general" }
        val file = File(dir, "adglasses_${safeType}_$timestamp.txt")

        file.writeText(
            buildString {
                appendLine("=== AD Glasses Debug Report ===")
                appendLine("Issue Type: $issueType")
