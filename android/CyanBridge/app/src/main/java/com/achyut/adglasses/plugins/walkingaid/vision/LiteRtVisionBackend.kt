...
class LiteRtVisionBackend(
    ...
    private fun initDetector() {
        try {
            val isYoloWorld = com.achyut.adglasses.plugins.walkingaid.WalkingAidPreferences.getYoloModelType(context) == com.achyut.adglasses.plugins.walkingaid.WalkingAidPreferences.MODEL_TYPE_YOLO_WORLD
    ...
    override suspend fun detect(frame: VisionFrame): DetectionResult = withContext(Dispatchers.Default) {
        ...
        val watchlist = com.achyut.adglasses.plugins.walkingaid.WalkingAidPreferences.getWatchlistTerms(context)
