...
object LocalAgentPrefs {
    ...
    fun getProviderType(context: Context): AgentProviderType {
        ...
        return when (raw) {
            ...
            "API_MODELS" -> AgentProviderType.CLOUD_API
            AgentProviderType.CLOUD_API.name -> AgentProviderType.CLOUD_API
    ...
    fun getGlassesAssistantMode(context: Context): GlassesAssistantMode {
        ...
        val mode = when (stored) {
            ...
            "CUSTOM_AI_PROVIDER" -> GlassesAssistantMode.CUSTOM_AI_PROVIDER
