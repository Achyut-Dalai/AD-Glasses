...
import com.achyut.adglasses.memoryvault.MemorySyncPreparationService
...
import com.achyut.adglasses.privacy.LocalDataBackupManager
import com.achyut.adglasses.privacy.LocalDataClearer
...
import com.achyut.adglasses.ui.appearance.AppearanceActivity
...
class SettingsActivity : AppCompatActivity(), SettingsScreenActions {
    ...
    override fun exportLocalData() {
        val fileName = "adglasses_backup_${SimpleDateFormat("yyyyMMdd_HHmm", Locale.US).format(Date())}.zip"
