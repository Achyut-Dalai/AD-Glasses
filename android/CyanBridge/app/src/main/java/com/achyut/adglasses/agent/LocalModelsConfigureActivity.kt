...
import com.achyut.adglasses.shared.localmodels.catalog.LocalModelCatalogRepository
        ...
        androidx.appcompat.app.AlertDialog.Builder(this)
            ...
            .setMessage(
                buildString {
                    ...
                    appendLine()
                    appendLine("To get an API key from AD Glasses Model Studio (desktop):")
                    appendLine()
                    appendLine("1. Open AD Glasses Model Studio on your desktop")
