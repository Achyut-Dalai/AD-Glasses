        ...
        LazyColumn(
            ...
            item {
                ADPageHero(
                    ...
                    status = if (transferActive) "SYNCING" else "LOCAL",
                    statusTone = if (transferActive) ADStatusTone.INFO else ADStatusTone.NEUTRAL,
                ) {
                    Button(
                        onClick = onOpenSync,
                    ...
                    ADCard(onClick = onOpenSync) {
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            ...
                            Column(Modifier.padding(start = 12.dp).weight(1f)) {
                                ...
                                Text("Open Sync for live transfer progress", style = MaterialTheme.typography.bodySmall, color = ADColors.Muted)
                            }
            ...
            item {
                Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                    ADSectionEyebrow("On this phone")
