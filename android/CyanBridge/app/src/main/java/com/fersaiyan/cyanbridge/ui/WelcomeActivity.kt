...
/** Launcher only. Product presentation now lives in the React Native shell. */
class WelcomeActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        // MainActivity remains underneath as the proven glasses runtime during the
        // brownfield migration. React Native owns everything the user sees.
